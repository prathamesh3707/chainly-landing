...
function Test() {
	return (
		<div>
			...
			{/* Boxes */}
			<div
				className="flex flex-col md:flex-row justify-evenly w-5/6  mx-auto"
				style={{ background: "#000211", width: "100%", paddingBottom: "5rem" }}
			>
				<div className={styles.rightImage}></div>

				<div className="md:mx-auto border w-96 border-brand rounded-lg h-3/5 p-2 my-8 bg-gradient-to-b from-back to-black">
					<div
