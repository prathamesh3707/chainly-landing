...
function Test() {
	return (
		<div style={{ position: "relative" }}>
			...
			>
				<div className={styles.rightImage}></div>
				<div className="w-11/12 sm:w-5/6 md:w-1/3 lg:w-1/4 xl:w-96 border border-brand rounded-lg p-2 my-8 mx-2 md:mx-4 lg:mx-8 bg-gradient-to-b from-back to-black mx-auto">
					<div
